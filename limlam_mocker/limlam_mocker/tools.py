...
def chi_to_redshift(chi, cosmo):
    ...
    """
    # zinterp = np.linspace(0,4,10000) # original
    zinterp = np.linspace(0,6.5,10000) # changed for George's z=4.77-6.21 sim data because of error in calling m.maps (May 17) - Clara
